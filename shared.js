  ...
  navbar.innerHTML =
    '<div class="container">' +
      '<div class="navbar-inner">' +
        ...
        '<button class="hamburger" id="hamburger" data-menu-toggle="true" aria-label="Open navigation menu" aria-expanded="false" aria-controls="mobileDrawer">' +
          '<span></span><span></span><span></span>' +
        '</button>' +
      '</div>' +
    '</div>' +
    '<div class="nav-links" id="mobileDrawer" data-nav-menu="true" aria-hidden="true">' +
